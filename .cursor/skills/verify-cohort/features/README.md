...
- [Bot roster](./bot-roster.md) covers Hatch on launch, the Crew heading, an empty Hatch thread with a Message composer, persistence across reopen, and clicking Hatch staying current.
...
- [Talk to Hatch](./talk.md) covers sending a message on the Hatch pane and seeing Hatch's reply.
