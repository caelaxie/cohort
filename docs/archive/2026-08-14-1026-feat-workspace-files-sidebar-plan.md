...
- **Product authority:** `AGENTS.md` and `ROADMAP.md` v1. This Product Contract wins on file-name visibility. `docs/archive/2026-08-13-1656-feat-cohort-desktop-workspace-loop-plan.md` remains authority for roster, add-files, and box, except the no-name-list rule this contract reopens.
...
- First workspace loop (`docs/archive/2026-08-13-1656-feat-cohort-desktop-workspace-loop-plan.md`)
  - Enables this plan
...
- `docs/archive/2026-08-13-1656-feat-cohort-desktop-workspace-loop-plan.md` — first loop; short success and no name list
